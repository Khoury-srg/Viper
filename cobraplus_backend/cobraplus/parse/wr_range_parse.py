...
def construct_single_txn4wrrange(line, txn_id):
    """
    ...
    for micro_op in cur_txn_dict[Keyword('value')]:
        ...
        if parsed_micro_op[0] == 'range':
            ...
            if parsed_micro_op[0] == 'r':
                ...
                if parsed_micro_op[0] == 'w':
                    succ = micro_op[3]
                    parsed_micro_op.append(succ)
...
def construct_all_txns(logs, callback):
    """
    ...
    for i in range(len(logs)):
        ...
        for j in range(len(lines)):
            ...
            #         and isinstance(cur_txn['value'][0][5], bool) and cur_txn['value'][0][5]: # TODO: Tricky part, FIXME
            #     final_txn_index = (i, j)
            #     continue
