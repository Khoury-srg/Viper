...
# for(( i=0;i<3;i++)) do
    python3.8 -m cobraplus_backend.cobraplus.main_allcases --config_file cobraplus_backend/cobraplus/config.yaml --algo 8 \
    --sub_dir fig12/${SUBDIRS[i]} \
    --perf_file $OUTPUT_FILE --exp_name viper_${SUBDIRS[i]}
done;