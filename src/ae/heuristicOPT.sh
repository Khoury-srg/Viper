...
#    --sub_dir heuristicOPT/${SUBDIRS[i]}/json \
#    --perf_file $OUTPUT_FILE --exp_name MonoASI_${EXPNAMES[i]} \
#    --format json
#done;
##
#for(( i=0;i<${#EXPNAMES[@]};i++)) do
## for i in "23"; do
#    timeout $TIMEOUT python3.8 main_allcases.py --config_file config.yaml --algo 11 \
#    --sub_dir heuristicOPT/${SUBDIRS[i]}/json \
#    --perf_file $OUTPUT_FILE --exp_name MonoASI_HEU_${EXPNAMES[i]} \
#    --format json
#done;
...
#    --sub_dir heuristicOPT/${SUBDIRS[i]}/json \
#    --perf_file $OUTPUT_FILE --exp_name MonoASIOPT_${EXPNAMES[i]} \
#    --format json
#done;
###
#for(( i=0;i<${#EXPNAMES[@]};i++)) do
## for i in "23"; do
#    timeout $TIMEOUT python3.8 main_allcases.py --config_file config.yaml --algo 12 \
#    --sub_dir heuristicOPT/${SUBDIRS[i]}/json \
#    --perf_file $OUTPUT_FILE --exp_name MonoASIOPT_HEU_${EXPNAMES[i]} \
#    --format json
#done;